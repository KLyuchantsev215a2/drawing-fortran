...
ss8=load('output_C_11_r_8.txt');
ss9=load('output_C_41_r_8.txt');
...
ss7=load('time.txt');
plot(ss8(:,4), ss8(:,1),'r',ss8(:,4), ss8(:,3),'r',ss8(:,4), ss8(:,2),'r',ss9(:,4),ss9(:,3),'b',ss9(:,4),ss9(:,2),'b',ss9(:,4),ss9(:,1),'b',ss5(:,2),ss5(:,3),'k',ss4(:,2), ss4(:,3),'k',ss6(:,2), ss6(:,3),'k');
